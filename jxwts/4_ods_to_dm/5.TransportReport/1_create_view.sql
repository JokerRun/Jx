...
-- 联系方式：driverPhone
    ...
    sum(ROUND((CASE
        WHEN ods_jxwts.ediasnpackage.packagetype = 1 THEN ods_jxwts.part.lulength/1000 * ods_jxwts.part.luwidth/1000 * ods_jxwts.part.luheight/1000
        WHEN ods_jxwts.ediasnpackage.packagetype = 3 THEN ods_jxwts.part.kltlength/1000 * ods_jxwts.part.kltwidth/1000 * ods_jxwts.part.kltheight/1000
