...
CREATE TABLE `link_edi_package`  (
  ...
  `h_delivery_node_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `h_transport_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `h_position_hk` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`l_package_hk`) USING BTREE,
  UNIQUE INDEX `uk_hub_user`(`h_package_hk`, `h_delivery_node_hk`, `h_transport_hk`, `h_position_hk`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `link_edi_package_moving_log`  (
  `l_package_moving_log_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `load_date` date NULL DEFAULT NULL,
  `record_source` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `hash_diff` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `package_moving_log_id` int(11) NOT NULL,
  `package_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `position_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `delivery_note_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `transport_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `whouse_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `car_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `driver_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `creator_hk` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`l_package_moving_log_hk`) USING BTREE,
  UNIQUE INDEX `uk_hub_user`(`package_moving_log_id`, `whouse_hk`, `car_hk`, `driver_hk`, `creator_hk`, `package_hk`, `position_hk`, `delivery_note_hk`, `transport_hk`) USING BTREE
